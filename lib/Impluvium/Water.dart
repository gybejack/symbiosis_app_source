...
class ImpluviumAnimation extends StatefulWidget {
  const ImpluviumAnimation({Key? key}) : super(key: key);

  @override
  _ImpluviumAnimationState createState() => _ImpluviumAnimationState();
}

class _ImpluviumAnimationState extends State<ImpluviumAnimation>
    ...
    return Container(
      decoration: const BoxDecoration(
          image: DecorationImage(
              image: AssetImage("images/impl.png"), fit: BoxFit.cover)),
      child: Stack(
        children: [
          Center(
            child: Text(
...
class MyPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    var paint = Paint()
      ..color = const Color(0xffCBE8F3).withOpacity(.8)
